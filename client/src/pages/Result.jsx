  ...
  return (
    ...
    <div>
      ...
      {!isImageLoaded && <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
        ...
        <button type='submit' className='inline-flex items-center gap-1 px-4 py-1 rounded-full bg-black text-white m-auto hover:scale-105 transition-all duration-500'>Generate <img src={assets.star_group} width={33}/></button>
